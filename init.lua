...
require('lazy').setup({
...

  {
    ...
    keys = {
      ...
      { '<C-t>', function() require('opencode').toggle() end, desc = 'Toggle embedded opencode', mode = "t", },
  ...
  --   },
  --   -- config = function()
  --   --   vim.keymap.set('n', '<leader>cc', '<CMDCopilotChatOpen<CR>', { desc = 'Open Copilot Chat' })
  --   -- end,
...
local on_attach = function(_, bufnr)
  ...
  -- nmap('<leader>ca', vim.lsp.buf.execute_command, '[C]ode [A]ction')
